        ...
        <div class="card mt-4">
            <div class="card-body">
                ...
                <table id="table_id" class="display">
                    <thead>
                        <tr>
                        <h1 style="  font-family: 'Bebas Neue', cursive; text-align: center; font-size: 50px; ">Client Exercise Logs</h1>
                            <br>
                            <th>Name</th>
                            <th>Surname</th>
                            <th>Goals</th>
                    ...
                    <tbody>
                        <?php foreach ($profileInfo as $temp) : ?>
                            <tr>
                                ...
                                <td><?= $temp->Goals ?></td>
                                <td>
                                    <a href="./ClientsExerciseLog.php?User_ID=<?=$temp->User_ID?>" class="btn btn-primary">View Log</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
